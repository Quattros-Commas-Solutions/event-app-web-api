...
// ResponseType routes
router.get('/response-type', auth.authAdmin, (req, res) => responseTypeController.getAll(req, res));
router.get('/response-type/:value', auth.authAdmin, (req, res) => responseTypeController.getByValue(req, res));
